...
namespace mvcapplication.DataAccess.Migrations
{
    ...
    [Migration("20231108115516_shoppingCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mvcapplication.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mvcapplication.Models.ShoppingCart", b =>
                {
                    b.HasOne("mvcapplication.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mvcapplication.Models.Product", "Product")
                        .WithMany()
